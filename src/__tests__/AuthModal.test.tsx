...
describe('Test TargetComponent', () => {
    ...
    it('render', () => {
        ...
        expect(screen.getByText(CURRENT_AUTH_TYPE_VALUES.signup.toUpperCase())).toBeInTheDocument();
    })
    ...
    it('render', () => {
        ...
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'input').length).toEqual(2);
    ...
    render(<BrowserRouter>
        ...
        const [emailInput, passwordInput] = screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'input');
    ...
    it('render', () => {
        ...
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p').length).toEqual(2);
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p')[1].textContent).toEqual('Email must be correct')
    })
    ...
    it('render', () => {
        ...
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p').length).toEqual(2);
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p')[1].textContent).toEqual('8 symbols, letters in both cases, numbers')
    })
    ...
    it('render', () => {
        ...
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p').length).toEqual(3);
        expect(screen.getAllByText((_, element) => element!.tagName.toLowerCase() === 'p')[2].textContent).toEqual('8 symbols, letters in both cases, numbers')
    })
});