...
import { getElementsByTagName } from "../../../utils/testHelpers";
...
export const expectUnauthDetailCardRendered = () => {
    ...
    expect(screen.getByText(`Rating: ${mockDetailCard.rating}`)).toBeInTheDocument();
...
export const expectAuthDetailCardRendered = () => {
    expect(getElementsByTagName('div')[2])
